...
# CONFIGURACIÓN
# ==========================================
CSV_ORIGINAL = "mtc_challenge-20260630T032548Z-3-003/mtc_challenge/train.csv"        # Tu CSV con las 54,263 líneas
DIR_IMAGENES = "train-001/train/"            # Carpeta con tus 54,263 imágenes
DIR_SALIDA = "datasets_porciones/"  # Carpeta principal de salida
PORCIONES = [1000, 1500, 2000]     # Tamaños de los subsets a generar
EXTENSION = ".jpg"                  # Ajusta a .png si es necesario
USAR_SYMLINKS = True                # True = usa accesos directos (0 bytes extra)
# ==========================================
